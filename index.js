...
haikal.sendMessage('6285848188568' + "@s.whatsapp.net", { text: `*Lapor! 🫡*\n\n_HW V19, bot berhasil terhubung ke server dengan baik_*` });
}
...
require("http").createServer((_, res) => res.end("UPTIME BOSKU 😎😎")).listen(8080)
