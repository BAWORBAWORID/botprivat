...
//=================================================//
global.owner = ['6285848188468'] // ubah aja pake nomor lu
//==========================BY Hw Mods=======================//
global.keyopenai = `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`
//====================BY Hw Mods=============================//
global.botname = '~_*©辛BAWOR MODS*_~' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
global.packname = 'Bot Whatsapp' // ubah aja ini nama sticker
global.author = '© BAWOR MODS' // ubah aja ini nama sticker
global.prefa = ['','!','.',',','🐤','🗿']
